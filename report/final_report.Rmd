...
Check out our GitHub! `https://github.com/andywang0321/Team_16-Stats_101C_Su24-Project.git`
...
![Distribution of Target Variable\label{dist}](img/distribution_log_total.png)
...
![Target Variable by State\label{boxplot_state}](img/boxplot_state.png)
...
![Target Variable by Month\label{boxplot_month}](img/boxplot_month.png)
...
![Log Total Over Time\label{logtotal_time}](img/logtotal_over_time.png)
...
![Count of Orders Over Time\label{count_time}](img/orders_over_time.png)
...
![Order Totals by State\label{map}](img/orders_by_state.png)
...
![Count of Male/Female vs. Log Total\label{mf}](img/logtotal_mf.png){height=300px}
...
![Scatter Plot Matrix of Log Total vs. Gender, Age, Income\label{pairs}](img/matrix.png)
...
![Correlation Matrix of All Numeric Variables\label{corr}](img/corr.png)
...
![Coarse-Grained Modelling Pipeline\label{coarse_pipeline}](img/train_pipeline.png)
...
![Fine-Grained Modelling Pipeline \label{fine_pipeline}](img/fine_pipeline.png)
...
![Illustration of Model Architecture\label{nn}](img/architecture.png){height=400px}
...
![Model Size vs. Mean MSE for Different Dropout Values\label{params}](img/params_vs_mse.png)
...
![Model Width vs. MSE for Different Model Depth and Dropout\label{arch}](img/hidden_vs_mse.png){width=700px}
